...
rnaseq_dds <- DESeqDataSetFromMatrix(countData = bc_df_cor3,
                                     colData = metadata,
                                     design= ~ condition)
...
p <- pca(bc_df_cor3, metadata = metadata %>%
...
high_med <- read.csv("/DATA/usr/m.trauernicht/projects/SuRE_deep_scan_trp53_gr/data/library_design/output/high_sequences.csv") %>%
...
med_low <- read.csv("/DATA/usr/m.trauernicht/projects/SuRE_deep_scan_trp53_gr/data/library_design/output/med_sequences.csv") %>%
  mutate(motif_id = paste(affinity_pos1, affinity_pos2, affinity_pos3, affinity_pos4, sep = "_"))
bc_df$affinity_id[bc_df$motif_id %in% med_low$motif_id] <- "4_med_low"

low_verylow <- read.csv("/DATA/usr/m.trauernicht/projects/SuRE_deep_scan_trp53_gr/data/library_design/output/low_sequences.csv") %>%
  mutate(motif_id = paste(affinity_pos1, affinity_pos2, affinity_pos3, affinity_pos4, sep = "_"))
bc_df$affinity_id[bc_df$motif_id %in% low_verylow$motif_id] <- "6_low_very-low"

verylow_zero <- read.csv("/DATA/usr/m.trauernicht/projects/SuRE_deep_scan_trp53_gr/data/library_design/output/verylow_sequences.csv") %>%
  mutate(motif_id = paste(affinity_pos1, affinity_pos2, affinity_pos3, affinity_pos4, sep = "_"))
