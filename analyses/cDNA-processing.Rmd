...
```{r out.width= "100%", fig.align= "center", echo=FALSE, warning= FALSE, message = FALSE}
## 5C-D: Linear model to fit most active reporters
...
## Fitting the model
x <- lm(MCF7_WT_Nutlin ~ spacing_degree_transf + promoter_background + close, cDNA_df_p53)
...
categorie <- c("promoter_background", "close", "spacing")
...
ggplot(cDNA_df_p53,
       aes(x = MCF7_WT_Nutlin, y = reporter_activity_predicted)) +
...
level_order <- c("_degree_transf","yes","minP_1", "minP_2", "minP_3", "mCMV_1", "mCMV_2", "mCMV_3")
...
## Figure 5E: Show that some reporters are superior to commercial reporters
compare_df <- cDNA_df %>%
...
## Figure 5F: Line-plot comparing sensitivities of my reporters to positive controls
