...
cDNA_df <- read.csv("/DATA/usr/m.trauernicht/projects/P53_reporter_scan/data/gcf6502/results/mt20220824_reporter_activity_filt.csv", header = T) 
...
## I should remove r3_gcf6412 due to their high basal activity (this is also in accordance with their pDNA contamination level
cDNA_df <- cDNA_df[-grep("MCF7_Nutlin_r3_gcf6412|MCF7_r3_gcf6412", cDNA_df$sample_id),]
...
x <- cDNA_df %>%
         filter(motif_id != "4_4_4_4", tf == "P53") %>%
...
ggplot(cDNA_df %>%
         filter(neg_ctrls == "No", promoter != "random", positive_ctrl == "No",
                str_detect(affinity_id, "[7]_"), position == 0, tf == "P53") %>%
