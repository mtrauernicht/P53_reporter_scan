...
cDNA_df <- read.csv("/DATA/usr/m.trauernicht/projects/SuRE_deep_scan_trp53_gr/data/gcf6210/results/mt20201209_reporter_activity_filt.csv", header = T)
...
affinity_df <- cDNA_df[cDNA_df$tf == "P53" & cDNA_df$neg_ctrls == "No" &
  ...
  dplyr::select(log_reporter_activity, ddG, cum_affinity, max_aff, condition, pDNA_counts_rpm) %>% unique()
